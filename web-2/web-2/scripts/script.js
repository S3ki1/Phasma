const evidenceToGhost = {
    ...
    dots: ["spirit", "jhin", "demon", "poltergeist", "hantu", "mare", "revenant", "shade", "onryo", "the-twins", "myling", "moroi", "obake", "the-mimic"],
...
function updateGhosts() {
    ...
    document.querySelectorAll(".ghost-list li").forEach(ghost => {
